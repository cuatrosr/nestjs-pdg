...
<h1 align="center">⭐ NestJS Analytics Service ⭐</h1>
...
7. 📌 Custom path aliases, where you can define your own paths (you will be able to use imports like `@/health` instead of `../../../src/health`).
